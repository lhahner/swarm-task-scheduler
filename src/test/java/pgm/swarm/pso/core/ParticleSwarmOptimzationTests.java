...
import pgm.swarm.pso.domain.scheduler.ParticleSwarmOptimizationScheduler;
...
public class ParticleSwarmOptimzationTests {
	...
	ParticleSwarmOptimizationScheduler pso;
	...
	public void runtests() {
		pso = new ParticleSwarmOptimizationScheduler();
	...
	public void testEvaluateScheduelingNegatives() {
		ParticleSwarmOptimizationScheduler pso = new ParticleSwarmOptimizationScheduler();
	...
	public void testOptimizeSchedueling() {
		...
		clh.generateCloudlets(2, 2, 20);
		Swarm<Particle> swarm = new Swarm<Particle>(0, 0, 3, Particle.class);
	...
	public void testoptimizeScheduelingOneVmAndTwoTasks() {
		...
		Swarm<Particle> ps = new Swarm<Particle>(0, 0, 2, Particle.class);
	...
	public void testoptimizeSchedueling100VmsAnd40Tasks() {
		...
		Swarm<Particle> ps = new Swarm<Particle>(0, 0, 8, Particle.class);
	...
	public void testoptimizeSchedueling500VmsAnd200Tasks() {
		...
		Swarm<Particle> ps = new Swarm<Particle>(0, 0, 32, Particle.class);
	...
	public void testoptimizeSchedueling1000VmsAnd400Tasks() {
		...
		Swarm<Particle> ps = new Swarm<Particle>(0, 0, 64, Particle.class);
